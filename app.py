...
tipo_prestamo = st.selectbox("Tipo de préstamo", ["COHEN TOMADOR", "COHEN TOMADOR T-BILLS", "COHEN PRESTAMISTA T-BILLS", "PRESTAMO ENTRE CLIENTES", "PRESTAMO ENTRE CLIENTES T-BILLS"])
